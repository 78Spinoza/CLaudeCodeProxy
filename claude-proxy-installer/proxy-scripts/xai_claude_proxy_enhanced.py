...
class ClaudeToolMapper:
    ...
    def generate_tool_schemas():
        ...
        return [
            {"type": "function", "function": {"name": "read_file", "description": "Read contents of a file", "parameters": {"type": "object", "properties": {"file_path": {"type": "string", "description": "Path to the file"}, "limit": {"type": "number", "description": "Lines to read (optional)"}, "offset": {"type": "number", "description": "Start line (optional)"}}, "required": ["file_path"]}}},
            {"type": "function", "function": {"name": "open_file", "description": "Open and read contents of a file (alias for read_file)", "parameters": {"type": "object", "properties": {"path": {"type": "string", "description": "Path to the file"}, "file_path": {"type": "string", "description": "Path to the file (alternative)"}, "limit": {"type": "number", "description": "Lines to read (optional)"}, "offset": {"type": "number", "description": "Start line (optional)"}}, "required": []}}},
            ...
            {"type": "function", "function": {"name": "multi_edit_file", "description": "Make multiple edits to one file", "parameters": {"type": "object", "properties": {"file_path": {"type": "string", "description": "Path to the file"}, "edits": {"type": "string", "description": "JSON array of edit operations"}}, "required": ["file_path", "edits"]}}},
            {"type": "function", "function": {"name": "run_bash", "description": "Run a shell command", "parameters": {"type": "object", "properties": {"command": {"type": "string", "description": "Command to run"}, "timeout": {"type": "number", "description": "Timeout in ms"}, "run_in_background": {"type": "boolean", "description": "Run in background"}}, "required": ["command"]}}},
